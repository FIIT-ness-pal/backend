...
export default class CreateFoods implements Seeder {
    ...
    await connection
        ...
        {id: '4ea26a6e-eda8-47b2-a7d2-9e339f943ab2', name: 'Pork chops', brand: '', description: '', calories: 114.6, carbs: 0.88, fat: 3.97, protein: 20.28, isPublic: false, user: adam},
        ...
        {id: 'e783f503-f170-4971-a4bd-359d5e679e93', name: 'Corn flakes', brand: 'Kelloggs', description: '', calories: 238.1, carbs: 57.14, fat: 0, protein: 4.76, isPublic: false, user: jakub},
